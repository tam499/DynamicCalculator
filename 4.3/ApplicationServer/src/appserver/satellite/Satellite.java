...
public class Satellite extends Thread {
    ...
    public void run() {
        ...
        // ---------------------------------------------------------------
        System.out.println("Registering satellite with application server...");
        try
        { 
            ...
            // create register satellite message
        ...
        {
            System.err.println("[Satellite] Error registering with application server: ");
            ex.printStackTrace();
        }
